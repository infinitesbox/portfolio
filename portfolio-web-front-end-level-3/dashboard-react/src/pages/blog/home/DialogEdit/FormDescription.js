...
export default class FormDescription extends React.Component
{
    ...
    {
        if(
            this.props.article && this.props.article && this.props.article !== prevProps.article
        )
        {
            console.log('update', this.props.article.description)
            this.editor.current.editor.setContents(this.props.article.description)
        }
    }
